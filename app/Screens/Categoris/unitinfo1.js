    ...
    Mailer.mail(
      {
        ...
        bccRecipients: [""],
        body:
          "I'm interested about reservation " + descs + " with Unit " + nounit,
        isHTML: true,
      },
      (error, event) => {
        Alert.alert(
      ...
      <Container style={Style.bgMain}>
        ...
        >
          ...
          >
            ...
            {this.state.getloads.build_up_area} {this.state.getloads.area_uom}
          </Text>
          {/* <Text style={{ fontSize: 16, marginLeft: 16, fontFamily: Fonts.type.sfuiDisplayBold }}>
                        Price : IDR <Text style={{color: "#49C60E"}}> {numFormat(this.state.price.trx_amt)} </Text>
                    </Text> */}
          ...
          (getURL == "FindUnitPage" && this.state.Group_cd != "Guest") ? (
            ...
            <View>
              ...
              >
                Price : IDR{" "}
                <Text style={{ color: "#49C60E" }}>
                  {" "}
                  {numFormat(this.state.price.trx_amt)}{" "}
                </Text>
              </Text> */}
              <View style={styles.lineStyle} />
              ...
              {/* <View style={styles.containersLooping}></View> */}
              ...
              {this.state.payments.map((data, key) => (
                <View key={key} style={[styles.containers, { paddingTop: 10 }]}>
                  ...
                  >
                    {getURL == "UnitEnquiryPage" ||
                    getURL == "FindUnitPage" ||
                    getRoutes == "propertydetail" ||
                    (this.state.Group_cd == "Guest" &&
                      this.state.Group_cd == "DEBTOR") ? (
                      <Button
                        rounded
                        full
          ...
          // getURL == 'UnitEnquiryPage' || getURL == 'FindUnitPage' && this.state.Group_cd == 'Guest' ?
          // <View>
        ...
        {/*                 
                {
                    this.state.Group_cd == 'ADMINWEB' || this.state.Group_cd == 'INHOUSE' || this.state.bookpage ?
                    // null 
                    <Button
                        rounded
                        full
                        style={{ backgroundColor: "#12173F", marginTop: 20 }}
        ...
        (this.state.Group_cd == "Guest" && this.state.Group_cd == "DEBTOR") ? (
          ...
          <Button
            rounded
            full
            style={{ backgroundColor: "#906c48", marginTop: 20 }}
            onPress={() => {
              this.clickBooking(item);
            }}
          >
            <Text style={{ fontFamily: Fonts.type.sfuiDisplaySemibold }}>
              Booking Now
            </Text>
          </Button>
        ) : null} */}
